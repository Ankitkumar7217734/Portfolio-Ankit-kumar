          ...
          <div className="flex h-16 items-center justify-between">
            ...
            <div className="flex items-center gap-8">
              ...
              >
                ...
                <div className="relative">
                  <div className="absolute inset-0 ai-gradient-primary rounded-lg blur-sm opacity-0 group-hover:opacity-20 transition-opacity duration-300"></div>
                  <div className="relative ai-gradient-primary p-2 rounded-lg group-hover:from-blue-600 group-hover:to-purple-700 transition-all duration-300">
                    <Code className="h-5 w-5 text-white" />
                  </div>
                </div>

                {/* Logo Text with Gradient */}
                <span className="ai-text-gradient group-hover:from-blue-700 group-hover:via-purple-700 group-hover:to-cyan-700 transition-all duration-300">
                  Portfolio
                </span>
                ...
                {navItems.map((item, index) => (
                  ...
                  >
                    ...
                    <span className="relative flex items-center gap-2 z-10">
                      ...
                      {item.logoComponent && <item.logoComponent />}
                    ...
                    {/* Active Indicator */}
                    {location.pathname === item.path && (
                      <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-1 h-1 ai-gradient-primary rounded-full"></div>
                    )}

                    {/* Hover Indicator */}
                    <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-0 h-0.5 ai-gradient-primary group-hover:w-8 transition-all duration-300 rounded-full"></div>
                  </Link>
                ))}
              </nav>
            </div>
        ...
        <div className="container flex flex-col items-center justify-between gap-4 md:h-20 md:flex-row">
          <div className="flex flex-col md:flex-row items-center gap-4">
            <p className="text-center text-sm text-muted-foreground md:text-left">
              ...
              <span className="ai-text-gradient font-medium ml-1">
                Ankit Kumar
              </span>
              . All rights reserved.
            </p>
