...
import { AlertCircle, Mail, Phone, MapPin, Github, Linkedin, Send, MessageCircle, Clock, User, CircuitBoard, Zap, Battery } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50/50 via-yellow-50/30 to-blue-50/50 dark:from-emerald-950/20 dark:via-yellow-950/10 dark:to-blue-950/20 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -right-40 w-80 h-80 bg-gradient-to-br from-emerald-400/20 to-yellow-400/20 rounded-full blur-3xl animate-pulse"></div>
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-gradient-to-r from-emerald-400/10 to-blue-400/10 rounded-full blur-3xl animate-pulse delay-500"></div>
      </div>
      ...
      <div className="relative max-w-7xl mx-auto px-3 sm:px-4 lg:px-6 py-8 sm:py-12">
        ...
        <div className="relative mb-12 sm:mb-16">
          ...
          <div className="relative bg-white/90 dark:bg-gray-900/90 backdrop-blur-xl rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12 border border-white/30 dark:border-gray-700/30 shadow-2xl text-center group hover:shadow-3xl transition-all duration-500 electrical-component">
            <div className="flex justify-center mb-6">
              <div className="relative group-hover:scale-110 transition-transform duration-500">
                <div className="absolute inset-0 bg-gradient-to-r from-emerald-600 via-yellow-600 to-blue-600 rounded-full blur-lg opacity-40 group-hover:opacity-60 transition-opacity duration-500"></div>
                <div className="relative w-16 h-16 sm:w-20 sm:h-20 bg-gradient-to-r from-emerald-600 via-yellow-600 to-blue-600 rounded-full flex items-center justify-center shadow-lg">
                  <CircuitBoard className="h-8 w-8 sm:h-10 sm:w-10 text-white group-hover:animate-bounce" />
                </div>
              </div>
            </div>
            ...
            <div className="relative">
              <p className="text-lg sm:text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto leading-relaxed">
                Have an electrical engineering project in mind or want to collaborate? I'd love to hear from you. 
                Let's create innovative electrical solutions together.
              </p>
        ...
        <div className="grid lg:grid-cols-3 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white/90 dark:bg-gray-900/90 backdrop-blur-xl rounded-2xl p-6 sm:p-8 border border-white/30 dark:border-gray-700/30 shadow-xl hover:shadow-2xl transition-all duration-500 group electrical-component">
              <div className="mb-8">
                <h2 className="text-2xl sm:text-3xl font-serif font-bold mb-3 flex items-center gap-3 group-hover:scale-105 transition-transform duration-300">
                  <div className="w-8 h-8 bg-gradient-to-r from-emerald-600 to-yellow-600 rounded-lg flex items-center justify-center shadow-lg group-hover:shadow-xl transition-shadow duration-300">
              ...
              <form ref={formRef} onSubmit={handleSubmit} className="space-y-6">
                <div className="grid sm:grid-cols-2 gap-4 sm:gap-6">
                  <div className="space-y-2 group">
                    <label className="text-sm font-medium text-gray-700 dark:text-gray-300 flex items-center gap-2 group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors duration-200">
                    ...
                    <Input
                      ...
                      required
                      className="h-12 bg-white/70 dark:bg-gray-800/70 border-gray-200 dark:border-gray-700 focus:border-emerald-500 dark:focus:border-emerald-400 focus:bg-white dark:focus:bg-gray-800 focus:shadow-lg transition-all duration-200 hover:shadow-md"
                    />
                  </div>
                  <div className="space-y-2 group">
                    <label className="text-sm font-medium text-gray-700 dark:text-gray-300 flex items-center gap-2 group-hover:text-yellow-600 dark:group-hover:text-yellow-400 transition-colors duration-200">
                    ...
                    <Input
                      ...
                      onChange={handleChange}
                      required
                      className="h-12 bg-white/70 dark:bg-gray-800/70 border-gray-200 dark:border-gray-700 focus:border-yellow-500 dark:focus:border-yellow-400 focus:bg-white dark:focus:bg-gray-800 focus:shadow-lg transition-all duration-200 hover:shadow-md"
                    />
                  </div>
                </div>
